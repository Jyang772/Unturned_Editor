...
SOURCES       = sources/encoder.cpp \
		...
		inventoryedit.cpp moc_encoder.cpp \
		moc_mainwindow.cpp \
...
$(TARGET): ui_encoder.h ui_mainwindow.h ui_inventoryedit.h $(OBJECTS)  
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/Unturned_Editor1.0.0/ && $(COPY_FILE) --parents headers/encoder.h headers/mainwindow.h headers/currentInventory.h inventoryedit.h .tmp/Unturned_Editor1.0.0/ && $(COPY_FILE) --parents sources/encoder.cpp sources/main.cpp sources/mainwindow.cpp inventoryedit.cpp .tmp/Unturned_Editor1.0.0/ && $(COPY_FILE) --parents encoder.ui mainwindow.ui inventoryedit.ui .tmp/Unturned_Editor1.0.0/ && (cd `dirname .tmp/Unturned_Editor1.0.0` && $(TAR) Unturned_Editor1.0.0.tar Unturned_Editor1.0.0 && $(COMPRESS) Unturned_Editor1.0.0.tar) && $(MOVE) `dirname .tmp/Unturned_Editor1.0.0`/Unturned_Editor1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/Unturned_Editor1.0.0
...
compiler_rcc_clean:
compiler_moc_header_make_all: moc_encoder.cpp moc_mainwindow.cpp moc_inventoryedit.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_encoder.cpp moc_mainwindow.cpp moc_inventoryedit.cpp
...
compiler_uic_make_all: ui_encoder.h ui_mainwindow.h ui_inventoryedit.h
compiler_uic_clean:
	-$(DEL_FILE) ui_encoder.h ui_mainwindow.h ui_inventoryedit.h
